...
public class KeyActivity extends AppCompatActivity {
    ...
    String HttpUrl = "http://www.truemobilecare.com/android/userregtest.php";
    String HttpUrlMail = "http://www.truemobilecare.com/android/messag.php";
    SharedPreferences sharedpreferences;
    public static final String MyPREFERENCES = "MyPrefs" ;
    public static final String DEFAULT = "N/A";
    Intent intent;
    String shopid,actkey,name,email,phone,proof,id,front,imei,mob,typ,price,invoice_date,gadget,shop,mobshop,back,bill;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name = sharedpreferences.getString("names",DEFAULT);
        ...
        Toast.makeText(this, mobshop, Toast.LENGTH_SHORT).show();
        Toast.makeText(KeyActivity.this, ""+name+""+email+""+phone+""+proof+""+id+""+front+""+back+""+imei+""+mob+""+typ+""+price+""+invoice_date+""+gadget+""+shop+""+mobshop+""+shopid+""+bill, Toast.LENGTH_SHORT).show();
...
onBackPressed();
    ...
    private void Sendmail() {
        ...
        progressDialog.show();
        // Creating string request with post method.
        StringRequest stringRequest = new StringRequest(Request.Method.POST, HttpUrlMail,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String ServerResponse) {
                        // Hiding the progress dialog after all task complete.
