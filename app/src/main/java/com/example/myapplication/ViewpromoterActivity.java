...
public class ViewpromoterActivity extends AppCompatActivity {
    ...
    String HttpUrl = "http://www.truemobilecare.com/adminplus/promoterfullview.php";
                    ...
                    public void onResponse(String ServerResponse) {
                        ...
                        if(!ServerResponse.equalsIgnoreCase("error")) {
                            try {
                             ...
                             //   idprf.setText(obj.getString("pro_idproof"));
                              //  resume.setText(obj.getString("pro_resume"));
                              //  bank.setText(obj.getString("pro_bank"));
