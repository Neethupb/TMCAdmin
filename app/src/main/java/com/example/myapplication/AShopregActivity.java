...
EditText shopname,address,owner,mobile,mail,pass,location,gst;
String shop,adres,ownr,mobl,email,passs,lctn,gstin;
    ...
    String HttpUrl = "http://www.truemobilecare.com/adminplus/shopreg.php";
Button reg,back;
    @Override
