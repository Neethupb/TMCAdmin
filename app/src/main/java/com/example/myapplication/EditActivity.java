...
public class EditActivity extends AppCompatActivity {
    ...
    Spinner promoter;
    String URL="http://www.truemobilecare.com/adminplus/promoterlist.php";
    String HttpUrl = "http://www.truemobilecare.com/adminplus/promoterupda.php";
    String HttpUrldelete = "http://www.truemobilecare.com/adminplus/promoterdelt.php";
    String HttpUrlview = "http://www.truemobilecare.com/adminplus/promoterview.php";
...
linear.setVisibility(View.GONE);
    ...
    private void DeletePromoter() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, HttpUrldelete,
    ...
    private void EditPromoter() {
        ...
        progressDialog.show();
        // Creating string request with post method.
        StringRequest stringRequest = new StringRequest(Request.Method.POST, HttpUrlview,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String ServerResponse) {
                        // Hiding the progress dialog after all task complete.
