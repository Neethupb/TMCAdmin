...
public class ShopeditActivity extends AppCompatActivity {
    ...
    String HttpUrlupdate = "http://www.truemobilecare.com/adminplus/shopupdate.php";
    ...
    String sname,saddress,sowner,smobile,smail,slocation;
    EditText name,address,owner,mobile,mail,location;
    @Override
    ...
    private void Updateshop() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, HttpUrlupdate,
                    ...
                    public void onResponse(String ServerResponse) {
                        ...
                        if (!ServerResponse.equalsIgnoreCase("error")) {
                            try {
                                ...
                                name.setText(obj.getString(""));
                                address.setText(obj.getString(""));
                                owner.setText(obj.getString(""));
                                mobile.setText(obj.getString(""));
                                mail.setText(obj.getString(""));
                                location.setText(obj.getString(""));
