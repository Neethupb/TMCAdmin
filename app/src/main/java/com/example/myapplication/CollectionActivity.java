...
public class CollectionActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener, View.OnClickListener {
    ...
    String HttpUrl = "http://www.truemobilecare.com/adminplus/outstanding.php";
    String HttpUrlcheque = "http://www.truemobilecare.com/adminplus/paycheque.php";
    String HttpUrlcash = "http://www.truemobilecare.com/adminplus/paycash.php";
   ...
   String mode,shop,name,id,shopname,collect,collected ,sellotedit,rate,remark,chequenumber,cheqdate;
   Button submit;
    public static final String DEFAULT = "N/A";
    String[] country = { "--Collection Mode--", "Cash ", "Cheque"};
EditText chequeno,amount,sellout,date,remarks;
    @Override
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
               ...
               // Toast.makeText(CollectionActivity.this, shop, Toast.LENGTH_SHORT).show();
                if (shop.equals("Mobile King-ernakulam")) {
                    Login();
                }
            }
            @Override
    ...
    private void CollectionCheque() {
       ...
       /* progressDialog.setMessage("Please Wait");
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, HttpUrlcheque,
    ...
    private void CollectionCash() {
       ...
       /* progressDialog.setMessage("Please Wait");
        progressDialog.show();*/
        // Creating string request with post method.
        StringRequest stringRequest = new StringRequest(Request.Method.POST, HttpUrlcash,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String ServerResponse) {
                        // Hiding the progress dialog after all task complete.
                            ...
                            try {
                              ...
                              //  Toast.makeText(CollectionActivity.this, collected, Toast.LENGTH_SHORT).show();
                                ...
                                if (!(collect.equals("")||collected.equals(""))) {
                                         ...
                                         // int a = (int) 0.8;
                                         int x = (atc * 80/100);
                                            /*Toast.makeText(CollectionActivity.this, ""+atc, Toast.LENGTH_SHORT).show();
                                            Toast.makeText(CollectionActivity.this, ""+ac, Toast.LENGTH_SHORT).show();
                                         //   Toast.makeText(CollectionActivity.this, ""+a, Toast.LENGTH_SHORT).show();
                                            Toast.makeText(CollectionActivity.this, ""+x, Toast.LENGTH_SHORT).show();*/
                                            int y = (x - ac);
